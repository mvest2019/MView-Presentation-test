 ...
 *
 * The design's `max-height:320px` is dropped. Header images are 16:9, so at the
 * 760px article column they want to be 427px tall; capping at 320 with
 * `object-cover` cropped a quarter of the frame away. Declared at the true 16:9
 * so the image sets its own height and nothing is cut.
 */
