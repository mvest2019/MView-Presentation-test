 ...
 * `details.blog` here — it would reach the DOM unsanitized.
 *
...
const ARTICLE_BODY = [
  ...
  // `scroll-mt` so a contents link does not park the heading under the sticky
  // 64px header.
...
export function ArticleBody({ preparedHtml }: { preparedHtml: string }) {
  return (
    <div
